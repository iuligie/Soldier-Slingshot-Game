...
namespace GooglePlayServices
{
    public static class GameIds
    {
        ...
        {
            public const string achievement_welcome = SlingshotSoldier.GPGSIds.achievement_welcome;
            public const string achievement_first_spark = SlingshotSoldier.GPGSIds.achievement_first_spark;
        ...
        public readonly static string LeaderboardId = SlingshotSoldier.GPGSIds.leaderboard_sparks_leaderboard;
    }
}